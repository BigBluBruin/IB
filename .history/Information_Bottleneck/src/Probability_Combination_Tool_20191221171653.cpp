...
std::vector<std::vector<double>> prob_combination_v2 (std::vector<std::vector<double>> & first_input, std::vector<std::vector<double>> & second_input, const char oper_type[])
{
    unsigned size_first=first_input[0].size();
    unsigned size_second=second_input[0].size();
