...
int main()
{
    ...
    double dc=6;
    double dv=3;
    std::vector<double> check_edge_dist{0,0,0,0,0,0,0,0.8140,0.1860};
    ...
    bool flag=true;
    int regular_result;
    double llr_intervel=pow(10.0,-4.0);
    ...
    while (flag)
    {
        ...
        Irregular_DE irregular_ins(check_edge_dist, vari_edge_dist,sigma2,max_iter,quansize,threshold,llr_intervel,);
